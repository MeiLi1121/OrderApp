//
//  OAProfilePaymentInfoView.swift
//  OrderApp
//
...
public protocol OAProfilePaymentInfoViewDelegate : UITableViewDataSource, UITableViewDelegate {
    func saveButtonTapped(_ sender: UIButton!)
}

class OAProfilePaymentInfoView: UIView {
    
    //MARK: Private Properties
    var paymentInfoTableView: UITableView!
    private var nextButton: UIButton!
    
    weak private var delegate: OAProfilePaymentInfoViewDelegate!
    
    //MARK: Life Cycle
    
    convenience init(delegate: OAProfilePaymentInfoViewDelegate) {
        ...
        nextButton = UIButton()
        nextButton.setTitle("Save", for: UIControlState())
