//
//  OAShoppingCartPayInfoViewController.swift
//  OrderApp
//
...
class OAShoppingCartPaymentInfoViewController: UIViewController, OAShoppingCartPaymentInfoViewDelegate, UITextFieldDelegate {
  ...
  private let kPaymentInfofilePath = "paymentInfo.json"
  
  //MARK:Properties
  
  private var payInfoView: OAShoppingCartPaymentInfoView?
  ...
  override func viewDidLoad() {
    super.viewDidLoad()
    self.payInfoView = OAShoppingCartPaymentInfoView(delegate: self)
    self.view = self.payInfoView
    
    self.title = "Enter Credit Card Info"
